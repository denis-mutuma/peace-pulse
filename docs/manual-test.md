...
13. Switch to steward role and confirm the guided scenario data appears across Dashboard, Evidence, Resources, and Rumors.
14. Filter incidents by status, category, and minimum severity.
15. Submit a short invalid report and confirm it is rejected without entering the offline queue.
